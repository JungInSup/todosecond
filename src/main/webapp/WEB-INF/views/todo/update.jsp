  ...
  <div class="row justify-content-center">
    <div class="col-lg-7">
      <div class="card shadow-lg border-0 rounded-lg mt-5">
        <div class="card-header"><h3 class="text-center font-weight-light my-4">Todo Update</h3></div>
        <div class="card-body">
          ...
          <form action="/todo/update" method="post">
            ...
            <div class="row mt-4 mb-6">
              ...
              <div class="form-floating col-md-4 d-grid">
                <button type="submit" class="btn btn-danger btn-block" onclick="location.href='/todo/list'">Delete</button>
              </div>
              <div class="form-floating col-md-4 d-grid">
                <!-- <button type="button" class="btn btn-primary btn-block" onclick="location.href='/todo/update?tno=${todo.tno}'">Modify</button> -->
                <button type="submit" class="btn btn-primary btn-block" onclick="location.href='/todo/list'">Modify</button>
              </div>
            </div>
          </form>
        </div>
